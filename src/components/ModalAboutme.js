...
const ModalAboutme = ({ onClose, content }) => {
  return (
      ...
      <div className="modal-content">
        ...
        <div className="modal-body">
          <div className="image-container">
            <img src={modalME} alt="Zdjęcie" oncontextmenu="return false;" />
          </div>
              <div className="text-container">
            <p>Hello, <br /><br />
&emsp;I am an ambitious person aspiring to become a Fullstack Developer. <br /></p>
<p>&emsp;Privately, I am the mother of a wonderful 4-year-old daughter.
One day I decided that I wanted to show her the world and be able to spend as much time with her as possible. Sitting at work 14 hours a day, I wasn't able to do it. I decided to turn my life upside down and do everything to make my dream come true. <br /></p>
<p>&emsp;While studying at the Wrocław University of Science and Technology, I learned about C++. I really like creating new functional things and I focus on details. In every job I came across websites that I didn't really like, so I started improving them together with the IT departments. I've been told I have a knack for it and pay attention to things they wouldn't think of.
Following the inspiration, I signed up for a course at goIT Fullstack Developer.
I am currently waiting for the desired certificate. I spent many sleepless nights studying and coding. I sacrificed a lot to be able to complete this course and make it to the end. <br /></p>
<p>&emsp;I am reliable, reliable and punctual
